...
/**
 * <code>BrokerService</code> class implements a general purpose broker service.
 * @deprecated
...
*/
@Deprecated
public final class BrokerService<T> extends BrokerServiceBase<T> {
     ...
     * Creates an instance.
     *
     * @param capacity the maximum number of subscribers the broker service will serve
     */
    public BrokerService(final int capacity) {
        super(capacity);
    }
}
