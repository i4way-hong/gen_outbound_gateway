...
public class WarmStandbyStateChangedEvent
    ...
    /**
     * Private field holding new WarmStandby service state value of the event.
     */
    private WarmStandbyState state;

    /**
     * Constructs a prototypical Event.
     *
     * @param source The object on which the Event initially occurred
     * @param newState new current state of the WarmStandbyService
     */
    protected WarmStandbyStateChangedEvent(
                final WarmStandbyService source,
                final WarmStandbyState newState) {
        super(source);
        this.state = newState;
    }
