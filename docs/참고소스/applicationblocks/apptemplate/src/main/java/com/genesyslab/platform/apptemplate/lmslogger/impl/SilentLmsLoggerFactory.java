...
/**
 * Implementation of {@link LmsLoggerFactory} which produces "silent" {@link LmsEventLogger}'s.
 */
public class SilentLmsLoggerFactory extends LmsLoggerFactory {

    public SilentLmsLoggerFactory() {
        this(null);
    }

    public SilentLmsLoggerFactory(final LmsMessageConveyor lmsc) {
        super(lmsc);
    }
    ...
    public LmsEventLogger getLmsLogger(final String name) {
        return SilentLmsEventLogger.SINGLETON;
    }
