...
public class MessageTypeOperand extends FilterOperand {

    @Override
    public ValueList evaluate(Message message, FilterContext context) {
        ValueList list = new ValueList();
        list.put(message.messageId());
        list.put(message.messageName());
        return list;
    }
    ...
    @Override
    public Object clone() {
        MessageTypeOperand obj = (MessageTypeOperand) super.clone();
        return obj;
    }
}
