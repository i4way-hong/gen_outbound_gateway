...
/**
 * Default builder of ESP Email Cluster Protocol Nodes.<br/>
 * It's automatically used if no custom builder specified.
 *
 * @see EspEmailClusterProtocolBuilder
 */
public class EspEmailProtocolBuilder
        extends ProtocolBuilder<EspEmailProtocol, EspEmailProtocolBuilder> {

    @Override
    public ProtocolDescription description() {
        return EspEmailProtocol.PROTOCOL_DESCRIPTION;
    }

    @Override
    protected EspEmailProtocol create() {
        return new EspEmailProtocol(null, refBuilder);
    }
}
