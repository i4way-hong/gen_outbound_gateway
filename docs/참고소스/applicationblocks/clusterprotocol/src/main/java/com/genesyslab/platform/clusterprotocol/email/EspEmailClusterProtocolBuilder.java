...
/**
 * <p/>ESP Email Server Cluster Protocol builder.
 *
 * <p/>Usage sample:<code><pre>
 * final EspEmailClusterProtocol emailNProtocol =
 *     new EspEmailClusterProtocolBuilder()
 ...
 *             .build();
 *
 * emailNProtocol.setNodesEndpoints(clusterEndpointsList);
 * emailNProtocol.open();
 *
 * // ...
 *
 * emailNProtocol.close();
 * </pre></code>
 */
public class EspEmailClusterProtocolBuilder
    ...
    @Override
    public EspEmailClusterProtocol build() {
        return new EspEmailClusterProtocol(
