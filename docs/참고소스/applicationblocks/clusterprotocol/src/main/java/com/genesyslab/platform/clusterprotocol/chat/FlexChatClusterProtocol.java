...
// ===============================================================================
package com.genesyslab.platform.clusterprotocol.chat;
 ...
 * {@link FlexChatClusterProtocolBuilder}.
 *
 * @see FlexChatClusterProtocolBuilder
 * @see FlexChatProtocol
 * @see com.genesyslab.platform.webmedia.protocol.flexchat.requests
 */
public class FlexChatClusterProtocol
        extends ClusterProtocolImpl
                <FlexChatProtocol,
                 FlexChatProtocolBuilder> {

    FlexChatClusterProtocol(
            final ProtocolBuilder<FlexChatProtocol, FlexChatProtocolBuilder> protoBuilder,
            final ClusterProtocolPolicy protocolPolicy,
            final ClusterProtocolLoadBalancer loadBalancer) {
        super(protoBuilder != null ? protoBuilder : new FlexChatProtocolBuilder(),
              protocolPolicy, loadBalancer);
    }

    @Override
    protected FlexChatProtocol createProtocol() {
        final FlexChatProtocol protocol = super.createProtocol();
        protocol.setAutoRegister(false);
        return protocol;
    }
}
