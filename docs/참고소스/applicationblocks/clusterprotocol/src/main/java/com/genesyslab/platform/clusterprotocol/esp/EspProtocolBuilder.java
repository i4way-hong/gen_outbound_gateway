...
/**
 * Default builder of External Service Cluster Protocol Nodes.<br/>
 * It's automatically used if no custom builder specified.
 *
 * @see EspClusterProtocolBuilder
 */
public class EspProtocolBuilder
        extends ProtocolBuilder<ExternalServiceProtocol, EspProtocolBuilder> {
    ...
    public ProtocolDescription description() {
        return ExternalServiceProtocol.PROTOCOL_DESCRIPTION;
    }
     ...
     */
    @Override
    protected ExternalServiceProtocol create() {
        return new ExternalServiceProtocol(null, refBuilder);
    }
}
