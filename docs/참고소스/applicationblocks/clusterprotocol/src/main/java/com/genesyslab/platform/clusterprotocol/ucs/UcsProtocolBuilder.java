...
/**
 * Default builder of Universal Contact Server Cluster Protocol Nodes.<br/>
 * It's automatically used if no custom builder specified.
 *
 * @see UcsClusterProtocolBuilder
 */
public class UcsProtocolBuilder
        extends ProtocolBuilder<UniversalContactServerProtocol, UcsProtocolBuilder> {
    ...
    /**
     * Creates new instance of Universal Contact Server Protocol as Cluster Protocol Node.
     */
    @Override
    protected UniversalContactServerProtocol create() {
        return new UniversalContactServerProtocol(null, refBuilder);
    }
}
