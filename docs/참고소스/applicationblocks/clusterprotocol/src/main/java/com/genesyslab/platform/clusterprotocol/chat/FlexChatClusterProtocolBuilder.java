...
/**
 * <p/>Genesys Chat Server Cluster Flex Protocol builder.
 *
 * <p/>Usage sample:<code><pre>
 * final FlexChatClusterProtocol flchatNProtocol =
 *     new FlexChatClusterProtocolBuilder()
 ...
 *             .build();
 *
 * flchatNProtocol.setNodesEndpoints(clusterEndpointsList);
 * flchatNProtocol.open();
 *
 * // ...
 *
 * flchatNProtocol.close();
 * </pre></code>
 */
public class FlexChatClusterProtocolBuilder
    ...
    @Override
    public FlexChatClusterProtocol build() {
        return new FlexChatClusterProtocol(
