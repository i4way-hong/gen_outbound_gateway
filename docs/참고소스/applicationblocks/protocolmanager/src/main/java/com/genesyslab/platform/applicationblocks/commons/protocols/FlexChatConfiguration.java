 ...
 *
 * @see com.genesyslab.platform.webmedia.protocol.FlexChatProtocolHandshakeOptions
 ...
 */
@Deprecated
public class FlexChatConfiguration
    ...
    public FlexChatConfiguration(final String name) {
        super(name, FlexChatProtocol.class);
    }
