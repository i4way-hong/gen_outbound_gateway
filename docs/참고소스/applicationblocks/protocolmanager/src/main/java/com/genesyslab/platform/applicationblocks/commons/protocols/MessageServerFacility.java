...
final class MessageServerFacility
    ...
    public Protocol createProtocol(final String name, final URI uri,
        ...
        return new MessageServerProtocol(new Endpoint(name, uri, tlsEnabled, sslContext, sslOptions));
    }
    ...
    public void applyConfiguration(
        ...
        MessageServerConfiguration messageServerConf = (MessageServerConfiguration) conf;
        MessageServerProtocol messageServerProtocol =
                    (MessageServerProtocol) instance.getProtocol();

        if (messageServerConf.getClientName() != null) {
            messageServerProtocol.setClientName(
                        messageServerConf.getClientName());
        }
        if (messageServerConf.getClientId() != null) {
            messageServerProtocol.setClientId(messageServerConf.getClientId());
        }
        if (messageServerConf.getClientType() != null) {
            messageServerProtocol.setClientType(
                        messageServerConf.getClientType());
        }
        if (messageServerConf.getClientHost() != null) {
            messageServerProtocol.setClientHost(messageServerConf.getClientHost());
        }
    }
}
