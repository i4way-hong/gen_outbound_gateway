...
class EspEmailFacility extends ProtocolFacility {
    ...
    public void applyConfiguration(
        ...
        EspEmailConfiguration emConf = (EspEmailConfiguration) conf;
        EspEmailProtocol emProtocol = (EspEmailProtocol) entry.getProtocol();
    ...
    public Protocol createProtocol(final String name, final URI uri,
        ...
        return new EspEmailProtocol(new Endpoint(name, uri, tlsEnabled, sslContext, sslOptions));
    }
}
