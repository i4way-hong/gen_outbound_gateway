...
import com.genesyslab.platform.webmedia.protocol.CallbackProtocol;
...
class CallbackFacility extends ProtocolFacility {
...
//
//        CallbackConfiguration cbConf = (CallbackConfiguration) conf;
//        CallbackProtocol cbProtocol = (CallbackProtocol) entry.getProtocol();
//
//        if (cbConf.getClientName() != null) {
//            cbProtocol.setClientName(cbConf.getClientName());
//        }
//    }
    ...
    public Protocol createProtocol(final String name, final URI uri,
        ...
        return new CallbackProtocol(new Endpoint(name, uri, tlsEnabled, sslContext, sslOptions));
    }
}
