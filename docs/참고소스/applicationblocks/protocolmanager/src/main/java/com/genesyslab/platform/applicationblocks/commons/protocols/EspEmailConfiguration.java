 ...
 *
 * @see com.genesyslab.platform.webmedia.protocol.EspEmailProtocolHandshakeOptions
 ...
 */
@Deprecated
public class EspEmailConfiguration extends ProtocolConfiguration {

    private String clientName;


    public EspEmailConfiguration(final String name) {
        super(name, EspEmailProtocol.class);
    }
