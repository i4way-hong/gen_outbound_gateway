...
import com.genesyslab.platform.routing.protocol.UrsCustomProtocol;
...
class RoutingCustomServerFacility extends ProtocolFacility {
    ...
    public Protocol createProtocol(final String name, final URI uri,
        ...
        return new UrsCustomProtocol(new Endpoint(name, uri, tlsEnabled, sslContext, sslOptions));
    }
}
