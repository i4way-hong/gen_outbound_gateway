...
import com.genesyslab.platform.webmedia.protocol.EmailProtocol;
 ...
 */
@Deprecated
class EmailFacility extends ProtocolFacility {
...
//
//        EmailConfiguration emConf = (EmailConfiguration) conf;
//        EmailProtocol emProtocol = (EmailProtocol) entry.getProtocol();
//
//        if (emConf.getClientName() != null) {
//            emProtocol.setClientName(emConf.getClientName());
//        }
//    }
    ...
    public Protocol createProtocol(final String name, final URI uri,
        ...
        return new EmailProtocol(new Endpoint(name, uri, tlsEnabled, sslContext, sslOptions));
    }
}
