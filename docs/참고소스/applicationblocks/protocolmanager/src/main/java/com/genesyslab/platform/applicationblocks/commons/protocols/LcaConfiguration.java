 ...
 *
 * @see com.genesyslab.platform.management.protocol.LocalControlAgentProtocolHandshakeOptions
 ...
 */
@Deprecated
public final class LcaConfiguration
        extends ProtocolConfiguration {

    private String clientName;
    private Integer clientId;
    private Integer processId;
    private ApplicationExecutionMode executionMode =
                ApplicationExecutionMode.Primary;
    private Integer controlStatus;


    public LcaConfiguration(final String name) {
        super(name, LocalControlAgentProtocol.class);
    }
    ...
    public void setExecutionMode(
            final ApplicationExecutionMode executionMode) {
    ...
    public String toString() {
        ...
        sb.append(MessageFormat.format("ProcessId: {0}\n", processId));
        sb.append(MessageFormat.format("ExecutionMode: {0}\n", executionMode));
        sb.append(MessageFormat.format("ControlStatus: {0}\n", controlStatus));
