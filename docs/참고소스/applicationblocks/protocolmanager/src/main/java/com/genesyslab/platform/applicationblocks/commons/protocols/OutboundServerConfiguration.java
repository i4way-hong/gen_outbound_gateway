 ...
 *
 * @see com.genesyslab.platform.outbound.protocol.OutboundServerProtocolHandshakeOptions
 ...
 */
@Deprecated
public final class OutboundServerConfiguration
        extends ProtocolConfiguration {

    private String clientName;
    private String client_ps_wrd;
    private String userName;
    private String user_ps_wrd;


    public OutboundServerConfiguration(final String name) {
        super(name, OutboundServerProtocol.class);
    }
