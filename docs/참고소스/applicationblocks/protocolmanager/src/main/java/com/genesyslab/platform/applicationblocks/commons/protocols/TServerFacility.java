...
final class TServerFacility
    ...
    public void applyConfiguration(
        ...
        TServerConfiguration tserverConf = (TServerConfiguration) conf;
        TServerProtocol tserverProtocol =
                    (TServerProtocol) instance.getProtocol();

        if (tserverConf.getClientName() != null) {
            tserverProtocol.setClientName(tserverConf.getClientName());
        }
        if (tserverConf.getClientPassword() != null) {
            tserverProtocol.setClientPassword(tserverConf.getClientPassword());
        }
    }
    ...
    public Protocol createProtocol(final String name, final URI uri,
        ...
        return new TServerProtocol(new Endpoint(name, uri, tlsEnabled, sslContext, sslOptions));
    }
}
