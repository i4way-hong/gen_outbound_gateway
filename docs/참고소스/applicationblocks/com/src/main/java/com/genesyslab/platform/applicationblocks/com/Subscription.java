 ...
 *
 * @see IConfService#subscribe(ICfgObject)
 * @see IConfService#subscribe(NotificationQuery)
 * @see IConfService#unsubscribe(Subscription)
...
public interface Subscription {
	...
	/**
     * Query used for the subscription.
     *
     * @return original query object
     */
    NotificationQuery getQuery();
}
