...
public class ConfigRuntimeException
    ...
    private static final long serialVersionUID = -1320946547734115054L;
     ...
     *
     * @param message Exception message
     * @param origin Original cause
     */
    public ConfigRuntimeException(final String message, final Throwable origin) {
