...
public final class ConfCacheEvent {
    ...
    private ICfgObject confObject;
    private ConfCacheUpdateType updateType;

    ConfCacheEvent(
            final ICfgObject confObject,
            final ConfCacheUpdateType updateType) {
     ...
     *
     * @return configuration object of the event
     */
