...
//===============================================================================
package com.genesyslab.platform.applicationblocks.quickstart;
...
class ConfigurationAccessor {
    ...
    private ConfServerProtocol createProtocol() {
        Endpoint desc = new Endpoint("ConfAcc#" + hashCode(), host, port);
        ConfServerProtocol protocol = new ConfServerProtocol(desc);

        protocol.setUserName(userName);
        protocol.setUserPassword(ps_wrd);
    ...
    /**
     * Returns the current state of the configuration server channel.
     * Should be used to determine whether a connection is opened.
     */
    ...
    public void initialize() {
        ...
        ps_wrd = ConfigurationManager.getAppOption("ConfServerPassword");
