...
public class initScsService {
	private final Logger logger = LoggerFactory.getLogger(this.getClass().getSimpleName());

	private GenesysInfoVo genesysinfovo;
	public IConfService service;

	private static initScsService m_initConfigServiceInstance = null;
	
	public initScsService() {
	}
	
	public static initScsService getInstance() {
        if (m_initConfigServiceInstance == null)
        	m_initConfigServiceInstance = new initScsService();
